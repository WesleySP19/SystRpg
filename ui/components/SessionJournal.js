                        ...
                        <div class="journal-card">
                            ...
                            <div style="display:flex; flex-direction:column; gap:10px;">
                                <div class="stat-pill">
                                    ...
                                    <strong style="color:#60a5fa;"><i class="fa-solid fa-shield-halved" style="margin-right:4px;"></i> ${players?.length || 0}</strong>
                                </div>
                                <div class="stat-pill">
                                    <span>Combates (Rodadas)</span>
                                    <strong style="color:#f87171;"><i class="fa-solid fa-swords" style="margin-right:4px;"></i> ${combatRound || 0}</strong>
                                </div>
                                <div class="stat-pill">
                                    <span>Sessão Atual</span>
                                    <strong style="color:#a78bfa;"><i class="fa-solid fa-hashtag" style="margin-right:4px;"></i> ${sessionNumber || 1}</strong>
                                </div>
                                <div class="stat-pill">
