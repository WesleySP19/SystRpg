...
// v15.9 UI Virtualization Cache (Memoization)
// Previne re-renderizações exaustivas de fragmentos HTML durante atualizações CRDT massivas.
...
export function HeroVitals({ hero }) {
    ...
    // Hash state simplificado para virtualização
    ...
    // Evita memory leak limpando o cache se crescer demais em campanhas absurdas
