...
import { Toast } from '../Toast.js'; // V19 use Toast instead of alert

/**
 * HERO SHEET V19.2.1 — "The Definitive Glassmorphism Refactor"
 * Orchestrates the sub-components and manages the top-level signals.
 */
export class HeroSheetV19 extends ReactiveComponent {
    constructor(opts) {
        super(opts);
    }
    ...
    handleRoll = (label, bonus) => {
        ...
        // Dispara um toast bonito em vez de travar a tela com um alert feio
        Toast.show(`${label} Rolado! Dado: ${roll} + ${bonus} = ${total}`, type);
        
        // Emite para a rede caso o chat esteja ouvindo
    ...
    template() {
        ...
        // Sub-componentes funcionais preact, envelopados na nova UI Glassmorphism
        return html`
