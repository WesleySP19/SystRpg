/**
 * COMBAT TIMER v1.0
 * Componente visual de timer por turno no combate.
 * Totalmente autônomo — apenas expõe start/stop/reset.
 */
export class CombatTimer {
    /**
     * @param {Object} opts
     * @param {number} opts.duration - Duração em segundos (default: 30)
     * @param {Function} opts.onExpire - Callback quando o tempo esgota
     * @param {Function} opts.onTick - Callback por segundo: (remaining, pct) => void
     */
    constructor(opts = {}) {
    ...
    /**
     * Renderiza a barra de progresso do timer diretamente em um elemento DOM.
     * @param {HTMLElement} el — elemento container
     * @param {string} actorName — nome do ator do turno atual
     */
