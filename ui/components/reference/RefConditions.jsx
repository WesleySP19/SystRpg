...
export function RefConditions() {
    const conds = [
        ...
        { name: 'Amedrontado (Frightened)', icon: 'fa-face-frown-open', effect: 'Desvantagem em testes de atributos e ataques enquanto a fonte do medo for visível. Não pode se aproximar da fonte voluntariamente.' },
        { name: 'Atordoado (Stunned)', icon: 'fa-brain', effect: 'Incapacitada, não pode se mover e fala com dificuldade. Falha automática em testes de FOR e DES. Ataques contra ela têm Vantagem.' },
        { name: 'Contido (Restrained)', icon: 'fa-link', effect: 'Deslocamento 0. Ataques contra a criatura têm Vantagem e seus ataques têm Desvantagem. Desvantagem em salvaguardas de Destreza.' },
        ...
        { name: 'Inconsciente (Unconscious)', icon: 'fa-bed', effect: 'Incapacitada, caída, não se move nem fala. Larga itens. Falha em FOR/DES. Ataques contra ela têm Vantagem e acertos a 1.5m são Críticos Automáticos.' },
