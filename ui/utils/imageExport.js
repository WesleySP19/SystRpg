...
/**
 * Helper to wrap text into lines fitting a maximum width on a canvas context.
 */
...
/**
 * Export a high-resolution "Resumo da Campanha / Crônica" PNG Card for Discord & WhatsApp sharing.
 * @param {Object} sessionData - Details of the RPG session (title, date, sessionNumber, players, loot, highlights, chronicle).
...
export async function exportSessionSummaryPNG(sessionData = {}, options = {}) {
  ...
  // 1. Background (Dark Obsidian with mystical gradients)
  ...
  // Corner flourishes (simple elegance)
  ...
  // 6. Chronicle / Highlights (Narrative Section)
  y += boxHeight + 50;
  ctx.font = 'bold 24px Cinzel, serif';
  ctx.fillStyle = '#c5a059';
