// public/workers/particleWorker.js
// Web Worker para processamento físico e renderização 2D pesada em OffscreenCanvas.
...
function initAmbient(width, height) {
    // Mantém as partículas de explosão (se houver), zera apenas as "ambientais"
...
self.onmessage = function(e) {
    ...
    if (msg.type === 'INIT') {
        ...
        if (canvas) {
            // Se as coordenadas não forem passadas, explode no centro
