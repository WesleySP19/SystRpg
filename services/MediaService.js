/**
 * MEDIA SERVICE
 * Isola a lógica complexa de processamento, upload e extração de imagens em Base64
 * para evitar sobrecarga no ciclo principal de Save/Load da sessão.
 */
export class MediaService {
    ...
    static async compressImageBase64(base64, maxWidth = 1080, quality = 0.8) {
        return new Promise((resolve) => {
            ...
            img.onload = () => {
                ...
                // Força WebP para otimização extrema
    ...
    static async resolveAndUpload(filename, value) {
        ...
        // Se for Base64 (data:image/...) enviamos para o Node e trocamos pela URL da pasta /data/images/
    ...
    static async restoreMedia(state) {
        ...
        const resolveUrl = async (url) => {
            ...
            // Opcional: Se for uma url de arquivo (/data/images/), poderíamos injetar a base64 de volta para o cliente,
            // mas manter apenas a URL é muito melhor para performance do frontend.
            return url;
        };
