/**
 * Monster art resolver — maps library creatures to coherent D&D-style portraits.
 * Priority: explicit monster.img → name lookup → type fallback → null (emoji portrait).
 */
