// public/workers/aiWorker.js
// Web Worker para processamento off-thread de Heurística NLP e buscas profundas (RAG).
// Mantém a interface do mestre sempre em 60 FPS, mesmo pesquisando 10.000 linhas de crônicas.
...
function performOracleSearch(query, state) {
    ...
    // Varre NPCs (pode conter milhares de registros em campanhas massivas)
    ...
    // Varre Diários e Crônicas de Sessão
...
function performLocalAsk(prompt) {
    ...
    // Gerador Procedural Massivo off-thread
