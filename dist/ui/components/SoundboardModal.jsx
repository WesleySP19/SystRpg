...
export function SoundboardModal({ unmount }) {
const categories = [
{
name: 'Combate & Ação',
sounds: [
...
<button class="btn btn-ghost text-gray-400 p-2" onClick={handleClose}>
<i class="fa-solid fa-times"></i>
</button>
</div>
<div class="p-6 max-h-[70vh] overflow-y-auto">
{categories.map(cat => (
<div class="mb-8 last:mb-0" key={cat.name}>
...
<button
key={s.id}
class="btn flex flex-col items-center gap-2 p-3 rounded-lg border border-white/10 bg-white/5 transition-all cursor-pointer hover:scale-105"
...
onInput={e => setMasterVolume(e.target.value)}
