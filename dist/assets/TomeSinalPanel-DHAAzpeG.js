import{C as p}from"./Boot-zbOxlXxn.js";import{C as r}from"./CRDTManager-CgAUmNs0.js";import"./main-9sWSJyi_.js";import"./BattleManager-0aKgsbKs.js";import"./jsxRuntime.module-B31ux8iJ.js";import"./FXEngine-CLpy8O3f.js";import"https://cdn.socket.io/4.7.4/socket.io.esm.min.js";import"./y-websocket-DdQpu-E3.js";class k extends p{constructor(e){super(e),this.masterId="DM_ACTIVE_MASTER",this.messages={},this.eventSource=null,this.activeTable=localStorage.getItem("DM_ACTIVE_TABLE")||"Mesa-01",this.sessionActive=!1,this.characterTokens=[],this.selectedCharId=null}template(){return this.store.state.players,`
