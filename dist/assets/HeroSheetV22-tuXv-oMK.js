var E=Object.defineProperty;var D=(e,r,t)=>r in e?E(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var I=(e,r,t)=>D(e,typeof r!="symbol"?r+"":r,t);import{R as P}from"./ReactiveComponent-DxMwUypL.js";import{d as O,D as M}from"./BattleManager-CjydHzBy.js";import{m as g}from"./main-Bk3T2ZrR.js";import{Toast as j}from"./Toast-m0Ci56ke.js";import"./Boot-CGoZOUiq.js";import"./jsxRuntime.module-B_1yG4TV.js";import"./FXEngine-CD41bvJc.js";import"https://cdn.socket.io/4.7.4/socket.io.esm.min.js";function N(e,r=1){const t=parseInt(r)||1,i=e||0;let a=300;t===1?a=300:t===2?a=900:t===3?a=2700:t===4?a=6500:t>=5&&(a=t*2e3);let p=Math.min(i/a*100,100);return{lvl:t,currentXP:i,nextXP:a,progress:p}}function R({hero:e}){if(!e)return null;const{lvl:r,currentXP:t,nextXP:i,progress:a}=N(e.xp,e.level);return g`
