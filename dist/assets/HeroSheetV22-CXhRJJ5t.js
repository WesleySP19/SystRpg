import{m as x,u as I}from"./Boot-iPu23rrC.js";import{d as E,D as P}from"./FXEngine-BKbXWGrS.js";import{Toast as D}from"./Toast-m0Ci56ke.js";import"./main-C1Nkaf1s.js";import"./tailwind-577Mf46G.js";function M(e,r=1){const a=parseInt(r)||1,i=e||0;let o=300;a===1?o=300:a===2?o=900:a===3?o=2700:a===4?o=6500:a>=5&&(o=a*2e3);let c=Math.min(i/o*100,100);return{lvl:a,currentXP:i,nextXP:o,progress:c}}function O({hero:e}){if(!e)return null;const{lvl:r,currentXP:a,nextXP:i,progress:o}=M(e.xp,e.level);return x`
