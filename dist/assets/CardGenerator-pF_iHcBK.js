import{C as u}from"./Boot-CEGxKzpF.js";import{T as p}from"./BattleManager-Dgd8rUvr.js";import{C as m}from"./CardRenderer-CTgGsrRT.js";import{Toast as g}from"./Toast-m0Ci56ke.js";import{e as b}from"./imageExport-Ck9NIU6v.js";import{P as y}from"./PersistenceService-CYwAMgIf.js";import"./main-DDqU0aTS.js";import"./FXEngine-DWu1Buon.js";import"https://cdn.socket.io/4.7.4/socket.io.esm.min.js";class P extends u{constructor(i){super(i),this._selectedHeroId=null,this._redrawTimer=null}template(){var r,t,a,o,s,n,d;const{players:i}=this.store.state,e=i==null?void 0:i.find(l=>l.id===this._selectedHeroId);return`
