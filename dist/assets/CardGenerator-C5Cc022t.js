import{C as g}from"./Boot-CGoZOUiq.js";import{T as p}from"./BattleManager-CjydHzBy.js";import{C as b}from"./CardRenderer-CTgGsrRT.js";import{Toast as m}from"./Toast-m0Ci56ke.js";import{e as h}from"./imageExport-Ck9NIU6v.js";import{P as u}from"./jsxRuntime.module-B_1yG4TV.js";import"./main-Bk3T2ZrR.js";import"./FXEngine-CD41bvJc.js";import"https://cdn.socket.io/4.7.4/socket.io.esm.min.js";class P extends g{constructor(r){super(r),this._selectedHeroId=null,this._redrawTimer=null}template(){var o,t,a,s,i,n,c;const{players:r}=this.store.state,e=r==null?void 0:r.find(d=>d.id===this._selectedHeroId);return`
