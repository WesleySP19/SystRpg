<<<<<<<< HEAD:dist/assets/WorldBuilder-ADrNB2DN.js
import{d as c,A as b,T as p}from"./FXEngine-Ck0EvS0v.js";import{u as y,m as h}from"./Boot-BBJyuWRn.js";import{Toast as s}from"./Toast-m0Ci56ke.js";import"./main-pAgcvAui.js";import"./tailwind-DeWATx8B.js";function R(x){y();const[a,d]=c(""),[w,C]=c("mysterious"),r=b(null),u=e=>{const t=e.target.closest("[data-action]");if(t){const o=t.dataset.action;o==="generateScene"&&m(),o==="copyToJournal"&&v()}},m=async()=>{var n,i;const e=(n=r.current)==null?void 0:n.querySelector("#scene-input"),t=(i=r.current)==null?void 0:i.querySelector("#tone-select"),o=e?e.value:"",f=t?t.value:"mysterious";if(!o)return s.show("Descreva brevemente o local.","warning");s.show("Tecendo a narrativa...");try{const l=`Descreva em um parágrafo imersivo para um mestre de RPG ler para os jogadores: ${o}. O tom deve ser ${f}.`,g=await p.ai.narrate(l);d(g)}catch{s.show("O oráculo está em silêncio...","danger")}},v=()=>{a&&(p.store.update(e=>{e.journalEntries=[...e.journalEntries||[],{id:Date.now(),timestamp:Date.now(),date:new Date().toLocaleDateString("pt-BR"),type:"info",title:"Descrição de Cena",content:a}]}),s.show("Cena salva na linha do tempo!"))};return h`
========
import{d as c,A as b,T as p}from"./FXEngine-BKbXWGrS.js";import{u as y,m as h}from"./Boot-DdpAL2Fg.js";import{Toast as s}from"./Toast-m0Ci56ke.js";import"./main-B4Qa-6Ou.js";import"./tailwind-hn7_9YSE.js";function R(x){y();const[a,d]=c(""),[w,C]=c("mysterious"),r=b(null),u=e=>{const t=e.target.closest("[data-action]");if(t){const o=t.dataset.action;o==="generateScene"&&m(),o==="copyToJournal"&&v()}},m=async()=>{var n,i;const e=(n=r.current)==null?void 0:n.querySelector("#scene-input"),t=(i=r.current)==null?void 0:i.querySelector("#tone-select"),o=e?e.value:"",f=t?t.value:"mysterious";if(!o)return s.show("Descreva brevemente o local.","warning");s.show("Tecendo a narrativa...");try{const l=`Descreva em um parágrafo imersivo para um mestre de RPG ler para os jogadores: ${o}. O tom deve ser ${f}.`,g=await p.ai.narrate(l);d(g)}catch{s.show("O oráculo está em silêncio...","danger")}},v=()=>{a&&(p.store.update(e=>{e.journalEntries=[...e.journalEntries||[],{id:Date.now(),timestamp:Date.now(),date:new Date().toLocaleDateString("pt-BR"),type:"info",title:"Descrição de Cena",content:a}]}),s.show("Cena salva na linha do tempo!"))};return h`
>>>>>>>> 972ecab325881c9c5d9ce15fd64e436b1f25c040:dist/assets/WorldBuilder-CCk4Hk90.js
