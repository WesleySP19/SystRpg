import{C as p}from"./Boot-DMC3Yg8D.js";import{C as r}from"./CRDTManager-CgAUmNs0.js";import"./main-BrOk6ySq.js";import"./BattleManager-CjydHzBy.js";import"./jsxRuntime.module-OTOYocg5.js";import"./FXEngine-CD41bvJc.js";import"https://cdn.socket.io/4.7.4/socket.io.esm.min.js";import"./y-websocket-DdQpu-E3.js";class k extends p{constructor(e){super(e),this.masterId="DM_ACTIVE_MASTER",this.messages={},this.eventSource=null,this.activeTable=localStorage.getItem("DM_ACTIVE_TABLE")||"Mesa-01",this.sessionActive=!1,this.characterTokens=[],this.selectedCharId=null}template(){return this.store.state.players,`
