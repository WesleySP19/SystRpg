import{m as n,_ as x}from"./main-9sWSJyi_.js";import{R as u}from"./ReactiveComponent-BnoCbmXI.js";import{T as c}from"./BattleManager-0aKgsbKs.js";import{Toast as f}from"./Toast-m0Ci56ke.js";import{C as h}from"./Boot-zbOxlXxn.js";import{a as v}from"./imageExport-Ck9NIU6v.js";import"./jsxRuntime.module-B31ux8iJ.js";import"./FXEngine-CLpy8O3f.js";import"https://cdn.socket.io/4.7.4/socket.io.esm.min.js";class b extends h{constructor(e={}){super(e),this._title=e.title||"Aviso",this._content=e.content||"",this._type=e.type||"info",this._onConfirm=e.onConfirm||null,this._onCancel=e.onCancel||null,this._resolve=null}static show(e){const o=document.createElement("div");o.id=`modal-${Date.now()}`,document.body.appendChild(o);const i=new b({...e,element:o});return i.mount(),i}static confirm(e,o,i="confirm"){return new Promise(t=>{b.show({title:e,content:o,type:i,onConfirm:()=>t(!0),onCancel:()=>t(!1)})})}static alert(e,o,i="info"){return new Promise(t=>{b.show({title:e,content:o,type:i,onConfirm:()=>t(!0)})})}template(){this._type;const e=this._type==="danger"?"fa-triangle-exclamation":this._type==="confirm"?"fa-circle-question":"fa-circle-info",o=this._type==="danger"?"border-red-500":"border-tomeGold",i=this._type==="danger"?"text-red-500":"text-tomeGold",t=this._type==="danger"?"bg-red-500 hover:bg-red-600":"bg-tomeGold hover:bg-tomeGold-bright";return`
                        ...
                        <div class="journal-card bg-black/40 backdrop-blur-md rounded-2xl p-6 border border-white/5 shadow-xl hover:border-accent/30 transition-colors">
                            ...
                            <div class="flex flex-col gap-3">
                                <div class="stat-pill bg-white/5 p-3 rounded-lg flex justify-between items-center text-sm border border-white/5">
                                    ...
                                    <strong class="text-blue-400"><i class="fa-solid fa-shield-halved mr-1.5"></i> ${(e==null?void 0:e.length)||0}</strong>
                                </div>
                                <div class="stat-pill bg-white/5 p-3 rounded-lg flex justify-between items-center text-sm border border-white/5">
                    ...
                    <div style="display:flex; flex-direction:column; gap:24px;">
                        ...
                        <div class="journal-card">
                            ...
                            <div class="timeline-track">
                                ...
                                ${(this.store.state.journalEntries||[]).slice().reverse().map(t=>{const s=t.type||"info",r={combat:"fa-swords",loot:"fa-coins",social:"fa-comments",info:"fa-scroll",oracle:"fa-wand-magic-sparkles"},a={combat:"#ef4444",loot:"#22c55e",social:"#3b82f6",info:"#c5a059",oracle:"#a855f7"},l={combat:"rgba(239, 68, 68, 0.35)",loot:"rgba(34, 197, 94, 0.35)",social:"rgba(59, 130, 246, 0.35)",info:"rgba(197, 160, 89, 0.35)",oracle:"rgba(168, 85, 247, 0.35)"},d=a[s]||a.info,p=l[s]||l.info,m=r[s]||r.info;return n`
...
`)}
        ...
        `).join("")||"Sem eventos registrados.";b.show({title:`Sessão #${t.sessionNumber}`,content:n`
            ...
            `,type:"info"})}copyCronicle(){this._aiCronicle&&(navigator.clipboard.writeText(this._aiCronicle),f.show("Crônica copiada com sucesso!","success"))}exportReport(){var t,s,r;const e=((t=this.$("#session-title-input"))==null?void 0:t.value)||"",o=((s=this.$("#session-notes-textarea"))==null?void 0:s.value)||"",i=((r=this.$("#session-loot-textarea"))==null?void 0:r.value)||"";c.store.update(a=>{a.sessionTitle=e,a.sessionNotes=o,a.sessionLoot=i}),f.show("Gerando relatório ilustrado para impressão...","info"),document.body.classList.add("print-report-mode"),window.print(),setTimeout(()=>document.body.classList.remove("print-report-mode"),500)}async exportSummaryPNG(){var a,l,d;const e=((a=this.$("#session-title-input"))==null?void 0:a.value)||this._sessionTitle,o=((l=this.$("#session-notes-textarea"))==null?void 0:l.value)||this._sessionNotes,i=((d=this.$("#session-loot-textarea"))==null?void 0:d.value)||this._sessionLoot,{players:t,sessionNumber:s,journalEntries:r}=this.store.state;c.store.update(p=>{p.sessionTitle=e,p.sessionNotes=o,p.sessionLoot=i}),f.show("Renderizando cartão místico PNG da sessão...","info");try{const p=(r||[]).map(g=>`• [${g.title}] ${g.content}`).join(`
`),m=this._aiCronicle||p||o;await v({title:e,sessionNumber:s||1,date:new Date().toLocaleDateString("pt-BR"),players:t||[],loot:i,chronicle:m,notes:o}),f.show("Cartão PNG gerado e baixado com sucesso!","success")}catch(p){console.error("[SessionJournal] Erro ao exportar PNG:",p),f.show("Falha ao exportar cartão PNG. Tente novamente.","danger")}}_renderReportTemplate(){const{players:e,combatRound:o,journalEntries:i,sessionNumber:t}=this.store.state,s=this._sessionLoot||"Nenhum item especial registrado.",r=new Date().toLocaleDateString("pt-BR");return n`
                ...
                <div style="display:grid; grid-template-columns: 1fr 1fr; gap:25px; margin-bottom:30px;">
                    <div style="border:1.5px solid #000; padding:15px; border-radius:8px; background:#fafafa;">
                        ...
                        <ul style="margin:0; padding-left:20px; font-size:11px; line-height:1.6; color:#222;">
                            ${(e||[]).map(a=>n`<li><strong>${a.name}</strong> (${a.race} ${a.class} Nív ${a.level})</li>`).join("")||"<li>Nenhum herói ativo.</li>"}
                        </ul>
                    </div>
                    <div style="border:1.5px solid #000; padding:15px; border-radius:8px; background:#fafafa;">
