import{m as p,_ as S}from"./main-DA10KFgB.js";import{R as I}from"./ReactiveComponent-Ddz_ABRu.js";import{T as l,D as E}from"./BattleManager-cUmVHNU7.js";import{M as k}from"./Boot-CB2yJVwc.js";import{Toast as g}from"./Toast-m0Ci56ke.js";import{M}from"./Modal-CH0DmhjX.js";import"./jsxRuntime.module-D87oBCZy.js";import"./FXEngine-Cu-70LmD.js";import"https://cdn.socket.io/4.7.4/socket.io.esm.min.js";function D(y){const e=y.store.state.quests||[];return e.length===0?p`<div class="text-xs text-slate-500 italic text-center p-4">Nenhuma missão ativa no momento.</div>`:e.map(t=>{const s=t.completed||t.status==="completed",a=t.failed||t.status==="failed";return p`
