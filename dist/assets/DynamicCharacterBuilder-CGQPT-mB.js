const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/BattleManager-cUmVHNU7.js","assets/BattleManager-bUeG3LKm.css"])))=>i.map(i=>d[i]);
import{_ as d}from"./main-DA10KFgB.js";import{C as m}from"./Boot-CB2yJVwc.js";import{C as l}from"./CRDTManager-CgAUmNs0.js";import"./BattleManager-cUmVHNU7.js";import"./jsxRuntime.module-D87oBCZy.js";import"./FXEngine-Cu-70LmD.js";import"https://cdn.socket.io/4.7.4/socket.io.esm.min.js";import"./y-websocket-DdQpu-E3.js";class w extends m{constructor(i){super(i),this.state=this.store.state,this.systemSchema=null,this.isLoading=!0,this.error=null}async onMount(){await this.fetchSystemSchema(),this._bindEvents()}async fetchSystemSchema(){try{const o=await(await fetch("/api/system/active")).json();o.status==="success"&&o.data?this.systemSchema=o.data.sheetSchema:this.error=o.message||"Sistema não encontrado."}catch{this.error="Erro ao carregar o sistema. Verifique a conexão com o servidor."}this.isLoading=!1,this.render()}template(){if(this.isLoading)return`<div style="text-align:center; padding: 50px; color:var(--accent); font-family: 'Cinzel';">Carregando Motor Multissistema...</div>`;if(this.error)return`<div style="text-align:center; padding: 50px; color:var(--danger);">${this.error}</div>`;const i=this.systemSchema,o=this.state.currentHero||{};return`
