...
import{_ as d}from"./main-BrOk6ySq.js";import{C as u}from"./Boot-DMC3Yg8D.js";import{C as l}from"./CRDTManager-CgAUmNs0.js";import"./BattleManager-CjydHzBy.js";import"./jsxRuntime.module-OTOYocg5.js";import"./FXEngine-CD41bvJc.js";import"https://cdn.socket.io/4.7.4/socket.io.esm.min.js";import"./y-websocket-DdQpu-E3.js";class w extends u{constructor(o){super(o),this.state=this.store.state,this.systemSchema=null,this.isLoading=!0,this.error=null}async onMount(){await this.fetchSystemSchema(),this._bindEvents()}async fetchSystemSchema(){try{const i=await(await fetch("/api/system/active")).json();i.status==="success"&&i.data?this.systemSchema=i.data.sheetSchema:this.error=i.message||"Sistema não encontrado."}catch{this.error="Erro ao carregar o sistema. Verifique a conexão com o servidor."}this.isLoading=!1,this.render()}template(){if(this.isLoading)return`<div style="text-align:center; padding: 50px; color:var(--accent); font-family: 'Cinzel';">Carregando Motor Multissistema...</div>`;if(this.error)return`<div style="text-align:center; padding: 50px; color:var(--danger);">${this.error}</div>`;const o=this.systemSchema,i=this.state.currentHero||{};return`
