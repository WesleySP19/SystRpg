import{C as p}from"./Boot-CEGxKzpF.js";import{C as r}from"./main-DDqU0aTS.js";import"./BattleManager-Dgd8rUvr.js";import"./PersistenceService-CYwAMgIf.js";import"./FXEngine-DWu1Buon.js";import"https://cdn.socket.io/4.7.4/socket.io.esm.min.js";class b extends p{constructor(e){super(e),this.masterId="DM_ACTIVE_MASTER",this.messages={},this.eventSource=null,this.activeTable=localStorage.getItem("DM_ACTIVE_TABLE")||"Mesa-01",this.sessionActive=!1,this.characterTokens=[],this.selectedCharId=null}template(){return this.store.state.players,`
