import{d as c,A as b,T as p}from"./FXEngine-BAazb45g.js";import{u as y,m as h}from"./Boot-0-7AJiQi.js";import{Toast as s}from"./Toast-m0Ci56ke.js";import"./main-Z61bTTRY.js";import"./tailwind-CVCQhc7L.js";function R(x){y();const[a,d]=c(""),[w,C]=c("mysterious"),r=b(null),u=e=>{const t=e.target.closest("[data-action]");if(t){const o=t.dataset.action;o==="generateScene"&&m(),o==="copyToJournal"&&v()}},m=async()=>{var n,i;const e=(n=r.current)==null?void 0:n.querySelector("#scene-input"),t=(i=r.current)==null?void 0:i.querySelector("#tone-select"),o=e?e.value:"",f=t?t.value:"mysterious";if(!o)return s.show("Descreva brevemente o local.","warning");s.show("Tecendo a narrativa...");try{const l=`Descreva em um parágrafo imersivo para um mestre de RPG ler para os jogadores: ${o}. O tom deve ser ${f}.`,g=await p.ai.narrate(l);d(g)}catch{s.show("O oráculo está em silêncio...","danger")}},v=()=>{a&&(p.store.update(e=>{e.journalEntries=[...e.journalEntries||[],{id:Date.now(),timestamp:Date.now(),date:new Date().toLocaleDateString("pt-BR"),type:"info",title:"Descrição de Cena",content:a}]}),s.show("Cena salva na linha do tempo!"))};return h`
